"""
ai package initialization with transparent unpickling shims for legacy saved models.
"""

from . import shims

try:
    if "expert_models" not in sys.modules:
    ...
    from .training.clinical import trainer, preprocessing, artifact_manager, data_loader, split, baselines
    from .training.fusion import meta_trainer, oof_generator, train_v4_fusion, fusion_data_loader
    from .evaluation import calibration, metrics, threshold_tuner, fusion_evaluator
    from .inference import expert_inference, fusion_inference
    from .explainability import expert_explainer, fusion_explainer

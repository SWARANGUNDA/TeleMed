...
SCHEMAS_DIR: Path = EXPERT_MODELS_DIR / "schemas"
SPLITS_DIR: Path = EXPERT_MODELS_DIR / "splits"
SAVED_MODELS_DIR: Path = EXPERT_MODELS_DIR / "saved_models"
REPORTS_DIR: Path = EXPERT_MODELS_DIR / "reports"
...
(REPORTS_DIR / "clinical").mkdir(parents=True, exist_ok=True)
(REPORTS_DIR / "wearable").mkdir(parents=True, exist_ok=True)
(REPORTS_DIR / "gut").mkdir(parents=True, exist_ok=True)

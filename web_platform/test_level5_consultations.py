...
from web_platform.backend.database import hash_password, create_auth_session
...
class TestLevel5Consultations(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.db_path = os.path.join(cls.temp_dir, "test_telemed_level5.db")
        ...
        cls.doc_a = database.create_user(
            email="dr_alpha@telemed.ai",
            password="DoctorPass123!",
            role="DOCTOR",
            profile_data={
                "full_name": "Dr. Alpha Specialist",
                "specialization": "Cardiology",
                "registration_number": "REG-CARD-101"
            }
        )
        ...
        cls.doc_b = database.create_user(
            email="dr_beta@telemed.ai",
            password="DoctorPass123!",
            role="DOCTOR",
            profile_data={
                "full_name": "Dr. Beta Specialist",
                "specialization": "Cardiology",
                "registration_number": "REG-CARD-102"
            }
        )
        ...
        cls.doc_pending = database.create_user(
            email="dr_pending@telemed.ai",
            password="DoctorPass123!",
            role="DOCTOR",
            profile_data={
                "full_name": "Dr. Pending Specialist",
                "specialization": "Cardiology",
                "registration_number": "REG-CARD-103"
            }
        )
        ...
        cls.patient_a = database.create_user(
            email="patient_alpha@telemed.ai",
        ...
        cls.rec_a1 = database.upsert_health_record(
            ...
            source_session_id="sess_alpha_101",
        ...
        cls.rec_a2 = database.upsert_health_record(
            user_id=cls.patient_a["user_id"],
            source_session_id="sess_alpha_102",
            patient_id=cls.patient_a["user_id"],

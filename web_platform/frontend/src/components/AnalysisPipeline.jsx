...
export function AnalysisPipeline({
  ...
  pathway = 'C+W+G',
  dqScore = 85.2,
  featureCounts = { clinical: 22, wearable: 15, gut: 20 },
  currentDocument = 'apollo_clinical_lab_sample.pdf',
  onNavigateDashboard,
  onNavigateXAI,
  onNavigateReport,
  onRetry,
  ...
  const pipelineStages = [
    ...
    { key: 'clin_expert', title: 'Clinical Expert v3', desc: 'Gradient Boosted Decision Trees (22 biomarkers)', icon: Activity, latency: 28 },
    { key: 'wear_expert', title: 'Wearable Expert v3', desc: '15D continuous sensor streams & circadian metrics', icon: Watch, latency: 32 },
    { key: 'gut_expert', title: 'Gut Expert v3', desc: '20 Taxa relative abundance microbial profiler', icon: Dna, latency: 30 },

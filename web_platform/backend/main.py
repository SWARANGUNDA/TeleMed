...
from .api import health_routes, intake_routes, predict_routes, rag_routes, xai_routes, v3_routes, auth_routes, admin_routes, records_routes, doctor_verification_routes, consultation_routes, appointment_notification_routes, audit_governance_routes, metrics_routes

...
from medical_rag_engine import config
from medical_rag_engine.evaluator import RAGEvaluator
from medical_rag_engine.ingestion import process_all_documents
from medical_rag_engine.rag_service import MedicalRAGService
from medical_rag_engine.vector_store import SemanticVectorStore

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("medical_rag_engine.pipeline")
